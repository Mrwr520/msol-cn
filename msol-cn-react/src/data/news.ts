...
export const NEWS_LIST: NewsItem[] = [
  {
    ...
    isoDate: '2025-11-13',
    category: '活动资讯',
    title: '新书首发 · 大咖力荐 | 2025 PMI项目管理大会在深圳圆满举行！',
    summary: '2025 PMI项目管理大会以"智驱万象 项启新篇"为核心主题，MSOL受邀参展并重磅推出新书《突破敏捷困境》。',
    image: '/images/news/pmi-2025/img_01.jpg',
    body: [],
    sourceUrl: 'https://mp.weixin.qq.com/s/HFw6O-kyfWQ-mAskvniGag',
    sourceLabel: 'PMO达人阁 微信公众号',
  },
  {
    slug: 'pmi-conference-2024',
    date: '2024.11.21',
    isoDate: '2024-11-21',
    category: '活动资讯',
    title: '【项有所成・行以致远】2024年PMI项目管理大会亮点集锦',
    summary: 'PMI(中国)大会首次在广州召开，麦嵩隆管理咨询作为合作伙伴受邀参加，与千余名项目管理从业者共同探讨项目成功之道。',
    image: '/images/news/pmi-2024/img_01.png',
    body: [],
    sourceUrl: 'https://mp.weixin.qq.com/s/r89mm7YBNPCY8DtEPypNOQ',
    sourceLabel: 'PMO达人阁 微信公众号',
  },
  {
    slug: 'ciie-2024',
    ...
    isoDate: '2024-10-31',
    category: '活动资讯',
    title: '邀请函 | 麦嵩隆管理咨询将首次亮相中国国际进口博览会',
    summary: '麦嵩隆管理咨询将于2024年11月5日至10日首次亮相上海国家会展中心进博会，诚邀您莅临3H馆临港展示区7号展台。',
    image: '/images/news/ciie-2024/img_01.png',
    body: [],
    sourceUrl: 'https://mp.weixin.qq.com/s/Kiwz9ffm52piVWmhTevehQ',
    sourceLabel: 'PMO达人阁 微信公众号',
  },
  {

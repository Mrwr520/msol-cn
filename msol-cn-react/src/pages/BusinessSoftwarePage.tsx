...
const SOLUTIONS = [
  {
    head: '组织',
    items: ['看不到项目全局而发愁', '方针决策不够果断迅速', '过去的教训不能得到有效的借鉴', '很多项目夭折'],
  },
  {
    head: '流程',
    items: ['直到问题出现了才开始制定策略', '报/联/商（汇报/联系/商量）不及时（没有）', '无法做出基于正确信息的决策'],
  },
  {
    head: '人',
    items: ['难以培养项目管理人才', '项目交给属下后总觉得不放心', '过分依赖个别掌握专业技术的人员', '项目管理这个词一听就觉得很难'],
  },
  {
    head: '管理工具',
    items: ['工具功能太多，没法有效利用', '看不到项目进行的实时状况', '希望能同时看到多个项目的进度状况', '镀金管理过多'],
  },
];
...
export default function BusinessSoftwarePage() {
  ...
  return (
    <>
      <PageHero
        title="PROEVER"
        subtitle="集中了专业项目管理公司积累的经验知识与方法论。PROEVER是一款引领项目成功，提升员工项目管理技能的软件。"
        crumbs={[
          { label: '首页', to: '/' },
      ...
      <div className="mx-auto max-w-5xl px-6 py-14">
        ...
        <ContentSection title="助推项目【0】失败。">
          <Reveal type="fade">
            <img src={assetUrl('/img/software/img_proever_function.png')} alt="" className="w-full rounded" />
          </Reveal>
          <p>
            麦嵩隆是一家专注于项目管理的咨询公司，多年来以大中型企业为中心，在项目管理方面积累了大量丰富经验与知识。
            PROEVER正是汇集了本公司知识与经验而研发完成的专业项目管理软件。通过项目可视化，导航等多种用户界面，提供包括利用过去的成败教训提取风险的风险管理，知识共享，相关方管理在内的各项功能，为您提供全方位项目管理支援。
          </p>
          <p>
            PROEVER各项功能都融入了我们过去各项目支援实践中积累起来的经验，用户在使用的过程中能自然地掌握或者提升项目管理的流程及知识体系。此外，用户还能通过知识库功能积累过去的成败经验教训形成企业资产，借鉴并找出解决问题的最佳策略。
          </p>
          <p>PROEVER还可以帮助您培养专业项目经理和PMO，从而提升企业项目管理的整体水平，引领项目成功。</p>
          <Reveal type="fade">
